 ...
 * and implements onBindItemHolder method to to display the item at the specified position.
 *
 */
interface ItemHolderBinder<T> {
     ...
     */
    fun onBindItemHolder(holder: BaseViewHolder<T>, item: T, position: Int)
